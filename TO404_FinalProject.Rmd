...
- Ride Length
```{r}
ggplot(data=master[master$distanceH < 10000,], aes(x=SNOW, y=tripduration, colour=usertype)) + geom_smooth()
```

- Total Rides
```{r}
totalRides <- tapply(master$bikeid, master$SNOW, mean, na.rm = TRUE)
```
