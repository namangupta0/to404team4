...
- Speed
```{r}
ggplot(data=master, aes(x=SNOW, y=speedMetersperMin, colour=usertype)) + geom_smooth() + labs(title = "Effects of Snow on Citi Bike Rider Speed", x = "Snow Depth (inches)", y = "Speed (meters per sec)")
```
